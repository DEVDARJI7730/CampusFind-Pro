<?php
/**
 * CampusFind Pro - View Lost Item Detail & QR Code
 */
...
<div class="container py-5 flex-grow-1">
    <div class="row g-4 justify-content-center">
        ...
        <div class="col-lg-8" data-aos="fade-right">
            <div class="glass-panel p-4 p-md-5 h-100">
                <div class="d-flex justify-content-between align-items-start flex-wrap gap-2 mb-3">
                    ...
                    <span class="badge badge-lost px-3 py-2 text-uppercase fs-7"><?php echo ucfirst($item['status']); ?></span>
                </div>
                ...
                <div class="row g-4">
                    ...
                    <div class="col-md-6 d-flex flex-column justify-content-between">
                        <div class="d-flex flex-column gap-3">
                            <div>
                                <span class="d-block text-muted" style="font-size: 0.85rem;"><i class="fa-solid fa-location-dot me-2 text-primary"></i>Lost Location:</span>
                                <span class="fw-600 fs-5 text-primary"><?php echo sanitize($item['location']); ?></span>
                            </div>
                            <div>
                                <span class="d-block text-muted" style="font-size: 0.85rem;"><i class="fa-regular fa-calendar me-2 text-primary"></i>Date Lost:</span>
                                <span class="fw-600 text-secondary"><?php echo formatDate($item['lost_date']); ?></span>
                            </div>
                            <?php if ($item['reward'] > 0): ?>
                                <div class="bg-success bg-opacity-10 border border-success border-opacity-20 p-3 rounded">
                                    <span class="d-block text-success fw-600" style="font-size: 0.85rem;"><i class="fa-solid fa-hand-holding-dollar me-2"></i>Cash Reward:</span>
                                    <span class="fw-800 fs-4 text-success">$<?php echo number_format($item['reward'], 2); ?></span>
                                </div>
                            <?php endif; ?>
                        </div>
                        ...
                        <div class="mt-4">
                            <?php if (isLoggedIn()): ?>
                                ...
                                <?php endif; ?>
                            <?php else: ?>
                                <a href="<?php echo SITE_URL; ?>/auth/login.php" class="btn btn-premium w-100 py-3"><i class="fa-solid fa-right-to-bracket me-2"></i>Login to Contact Owner</a>
                            <?php endif; ?>
                        </div>
                    </div>
                </div>

                <h5 class="font-heading fw-700 mt-5 mb-3">Item Description</h5>
                ...
                <?php if (isLoggedIn()): ?>
                    <div class="glass-panel p-4 mt-5 bg-opacity-25" style="background: var(--bg-secondary);">
                        <h6 class="font-heading fw-700 text-secondary mb-3"><i class="fa-solid fa-circle-user text-primary me-2"></i>Reported By</h6>
        ...
        <!-- Sidebar (QR Tracker details) -->
        <div class="col-lg-4" data-aos="fade-left">
            <div class="glass-panel p-4 text-center">
                <h5 class="font-heading fw-700 mb-3"><i class="fa-solid fa-qrcode text-primary me-2"></i>QR Code Registry</h5>
